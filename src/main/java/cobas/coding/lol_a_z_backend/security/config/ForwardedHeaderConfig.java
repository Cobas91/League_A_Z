 ...
 * </p>
 */
@Configuration public class ForwardedHeaderConfig {
	/**
	 ...
	 * </p>
	 */
	@Bean FilterRegistrationBean addForwardedPortHeader() {
	...
	private static class AddHeaderRequest extends HttpServletRequestWrapper {
		...
		@Override public Enumeration<String> getHeaderNames() {
			return new ChainedEnumeration<String>(super.getHeaderNames(), Collections.enumeration(Collections.singletonList(headerName)));
		}
	}
