...
@RestController @RequestMapping("/auth") public class LoginController {
	...
	@PostMapping("/password/reset") public String resetPassword(@RequestBody PasswordResetDTO passwordResetDTO) {
		return userService.triggerPasswordReset(passwordResetDTO);
	}

	@PostMapping("/password/change/token") public String changePasswordWithToken(@RequestBody PasswordResetDTO passwordResetDTO) {
		return userService.changePasswordWithToken(passwordResetDTO);
	}
}
